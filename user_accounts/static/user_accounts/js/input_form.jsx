        ...
        render: function() {
            return (
                <div id="request-form">
                    ...
                    <p><textArea maxLength="600" rows="3" className="form-control" placeholder="Description" value={this.state.description} ref="description" onChange={this.handleInput} /></p>
